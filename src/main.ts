...
import {ReviewsRepoService} from './app/shared/reviews-repo.service';
...
bootstrap(AppComponent, [FunPlaceRepoService,ReviewsRepoService,APP_ROUTER_PROVIDERS,GOOGLE_MAPS_PROVIDERS,
